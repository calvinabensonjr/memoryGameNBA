const cards = document.querySelectorAll('.memory-card'); //allows you to pick a card

let flippedCard = false; //tells you if a card is flipped
...
function unflipCard(){
  ...
  setTimeout(() =>{ //
    ...
    resetBoard();
  }, 1000); //how long it takes to flip the card the bigger the number the slower
}
...
})();//IIFE (imediatley invoked Function Expression) we invoked the function meaning that it will be executed right after the definitione
